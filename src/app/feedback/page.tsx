    ...
    return (
        <div className="py-2">
            ...
            <div className="flex flex-row gap-2 text-lg font-bold">
                ...
                Optional <span className="font-normal">(to be notified when the bug is fixed)</span>
            </div>
        </div>
    )
}
            ...
            <div className="flex-grow pt-14 p-8">
                <form className="max-w-[800px] w-full bg-backgroundBox rounded-borderRoundness m-auto p-6 flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-2">
                        <div>
                            <label className="font-bold text-lg" htmlFor="text">Name<Required spaceLeft={2} color="aqua" /></label>
                        ...
                        <div>
                            <label className="font-bold text-lg" htmlFor="email">Email<Required spaceLeft={2} color="aqua" /></label>
                        ...
                        <div>
                            <label className="font-bold text-lg" htmlFor="description">Description<Required spaceLeft={2} color="crimson" /></label>
                        ...
                        <div>
                            <label className="font-bold text-lg" htmlFor="game">Game URL/PGN</label>
                        ...
                        <input type="submit" className="w-fit h-fit py-1 px-2 mt-2 cursor-pointer rounded-borderRoundness text-lg bg-backgroundBoxBoxHighlighted hover:bg-backgroundBoxBoxHighlightedHover transition-all font-extrabold hover:shadow-shadowBoxBoxHighlighted" value="Send" />
                    </div>
                </form>
            </div>
        </div>
