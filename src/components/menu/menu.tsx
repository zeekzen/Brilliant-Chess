...
export default function Menu() {
    ...
    return (
        <div ref={menuRef} className="vertical:h-full w-full max-w-[500px] pb-8 vertical:pb-0 vertical:min-h-0 min-h-fit select-text bg-backgroundBox rounded-borderRoundness flex-grow vertical:max-w-[500px] vertical:min-w-[290px] flex flex-col gap-4 overflow-hidden">
