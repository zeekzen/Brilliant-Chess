...
export default function Loading(props: { format: string, analyzeController?: AbortController }) {
    ...
    return (
        <div className="flex flex-col flex-grow">
            ...
            <a href={DONATE_URL} target="_blank" className="inline hover:bg-black transition-colors w-full bg-backgroundBoxDarker text-sm px-3 py-2">If you're enjoying the app, consider making a donation to help cover the costs. Your support means a lot! <Heart class="inline fill-red-600" /></a>
