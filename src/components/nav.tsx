...
export default function Nav() {
    ...
    return (
        <nav className="pt-1 pb-6 h-screen w-fit bg-backgroundBox flex flex-col justify-between">
            <a href="/" className="flex flex-col font-bold *:p-3 *:transition-colors hover:*:bg-backgroundBoxHover text-lg hover:*:text-foregroundHighlighted">
                <div className="flex flex-row gap-1 text-xl font-extrabold">
                    <Image height={30} width={30} alt="logo" src="images/logo.svg" />
