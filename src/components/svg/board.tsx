export default function BoardIcon(props: { size: number, class: string }) {
    return (
        <svg className={props.class} width={props.size + "px"} height={props.size + "px"} viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
