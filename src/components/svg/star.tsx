export default function Star(props: { class: string, size: number }) {
    return (
        <svg className={props.class} height={props.size} width={props.size} version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <g>
		...
		C510.262,220.042,514.298,207.792,510.698,196.593z"/>
            </g>
        </svg>
    )
}