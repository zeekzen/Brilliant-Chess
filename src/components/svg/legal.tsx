export default function Legal(props: { class: string, size?: number, draggable?: boolean }) {
    return (
        <div draggable={props.draggable}>
            <svg className={props.class} width={props.size ?? 18} height={props.size ?? 18} viewBox="-2 0 19 19" xmlns="http://www.w3.org/2000/svg">
